...
# normal_tensorboardlogger_dir = "/home/vault/iwfa/iwfa048h/CNN/tensorboard_TRIAL"

# TRAINER_NON_OPTUNA_DIR = #"/home/vault/iwfa/iwfa048h/CNN/TRAINER_NON_OPTUNA_DIR_TRIAL"  #checkpoint saving
# CKPT_PATH= "/home/vault/iwfa/iwfa048h/CNN/TRAINER_NON_OPTUNA_DIR_TRIAL/last.ckpt" #"best"#"/home/vault/iwfa/iwfa048h/CNN/tensorboard_TRIAL/trial_cable/TRIAL_dropout_te/checkpoints/last.ckpt"#None#TRAINER_NON_OPTUNA_DIR


# base_path, last_component = os.path.split(TRAINER_NON_OPTUNA_DIR)
# new_path = os.path.join(base_path, logger_version, last_component, "last.ckpt")
# if not os.path.exists(new_path):
#    os.makedirs(new_path)
# CKPT_PATH = new_path
# /home/vault/iwfa/iwfa048h/CNN/TRIAL_drop/TRAINER_NON_OPTUNA_DIR_TRIAL/last copy.ckpt


# optuna
# optuna_tensorboard_study_name='_TRIALAR_dr'  #name under which trials are lodded in tensorboard not the dashboard name


# optuna_tensorboardlogger_dir= "/home/vault/iwfa/iwfa048h/CNN/optuna_trial_TRIAL"
...
# logger_version = "trial"#"fl_d201_ar_aug_nor_32bs_sigmoid_pretraining_vall_acc_dropout_g4"

# normal_tensorboardlogger_dir = "/home/vault/iwfa/iwfa048h/CNN/tolerancedatasettrail" #hyperparmater logs
# Misclassification_save_dir = "/home/vault/iwfa/iwfa048h/CNN/misclassification"
# TRAINER_NON_OPTUNA_DIR = "/home/vault/iwfa/iwfa048h/CNN/TRAINER_NON_OPTUNA_DIR"  #checkpoint saving
# CKPT_PATH="best"
# SKIP_MISCLASSIFY = True
# fast_dev_run = False

# ##optuna
# optuna_tensorboard_study_name='25_trails_32bs_vall_acc_fl_dr_g4' #name under which trials are lodded in tensorboard not the dashboard name
# QUANTITY_TO_OPTIMIZE = "vall_acc" #vall_loss,f1_micro,f1,vall_acc
# DIRECTION_OF_OPTIMIZATION = "maximize" #maximize,minimize
# DIRECTION_OF_OPTIMIZATION_SHORT ="max"
# n_trials = 2

# Sq_lite_file = "sqlite:///{}.db".format(logger_version) #"sqlite:///db.sqlite3datasetwoadjustment"
# optuna_tensorboardlogger_dir= "/home/vault/iwfa/iwfa048h/CNN/optuna_trial"  #trial wise logs
# TRAINER_OPTUNA_DIR = "/home/vault/iwfa/iwfa048h/CNN/TRAINER_OPTUNA_DIR" #checkpoint saving in optuna
